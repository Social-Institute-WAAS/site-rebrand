...
const isDev = !isProd && !isTest;
    ...
    function html() {
      return src('app/*.html')
        ...
        .pipe($.if(/\.css$/, $.postcss([cssnano({safe: true, autoprefixer: false, discardComments:  true})])))
    ...
    let serve;
    if (isDev) {
      serve = series(clean, parallel(styles, scripts, modernizr, fonts, assets), startAppServer);
    } else if (isTest) {
